    ...
    <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-primary/10">
      <nav className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 group">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center shadow-clay transition-transform group-hover:scale-105">
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link
            href="/tools"
            className="font-body font-medium text-text/80 hover:text-primary transition-colors"
          >
            所有工具
          </Link>
          <Link
      ...
      {isMenuOpen && (
        <div className="md:hidden px-4 pb-4 space-y-3 bg-background border-b border-primary/10">
          <Link
            href="/tools"
            className="block py-2 font-body font-medium text-text/80 hover:text-primary transition-colors"
          >
            所有工具
          </Link>
          <Link
